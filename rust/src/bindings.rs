...
const _: () = {
  ...
  unsafe extern "C" fn __export_add(arg0: f64,arg1: f64,) -> f64 {
...
const _: () = {
  ...
  #[export_name = "divide"]
  #[allow(non_snake_case)]
  unsafe extern "C" fn __export_divide(arg0: f64,arg1: f64,) -> f64 {
    #[allow(unused_imports)]
    use wit_bindgen::rt::{alloc, vec::Vec, string::String};

...
const _: () = {
  ...
  unsafe extern "C" fn __export_add(arg0: f32,arg1: f32,) -> f32 {
...
const _: () = {
  ...
  #[export_name = "divide"]
  #[allow(non_snake_case)]
  unsafe extern "C" fn __export_divide(arg0: f32,arg1: f32,) -> f32 {
    #[allow(unused_imports)]
    use wit_bindgen::rt::{alloc, vec::Vec, string::String};
    ...
    let result0 = <_GuestImpl as Guest>::divide(arg0, arg1);
    wit_bindgen::rt::as_f32(result0)
  }
};
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 301] = [3, 0, 4, 109, 97, 116, 104, 0, 97, 115, 109, 13, 0, 1, 0, 7, 181, 1, 1, 65, 2, 1, 65, 5, 1, 66, 4, 1, 109, 6, 5, 116, 114, 97, 99, 101, 5, 100, 101, 98, 117, 103, 4, 105, 110, 102, 111, 4, 119, 97, 114, 110, 5, 101, 114, 114, 111, 114, 8, 99, 114, 105, 116, 105, 99, 97, 108, 4, 0, 5, 108, 101, 118, 101, 108, 3, 0, 0, 1, 64, 3, 5, 108, 101, 118, 101, 108, 1, 7, 99, 111, 110, 116, 101, 120, 116, 115, 7, 109, 101, 115, 115, 97, 103, 101, 115, 1, 0, 4, 0, 3, 108, 111, 103, 1, 2, 3, 1, 20, 119, 97, 115, 105, 58, 108, 111, 103, 103, 105, 110, 103, 47, 108, 111, 103, 103, 105, 110, 103, 5, 0, 1, 64, 2, 1, 97, 118, 1, 98, 118, 0, 118, 4, 0, 3, 97, 100, 100, 1, 1, 4, 0, 6, 100, 105, 118, 105, 100, 101, 1, 1, 4, 1, 23, 102, 105, 115, 115, 105, 111, 110, 58, 109, 97, 116, 104, 47, 109, 97, 116, 104, 64, 48, 46, 49, 46, 48, 4, 0, 11, 10, 1, 0, 4, 109, 97, 116, 104, 3, 0, 0, 0, 16, 12, 112, 97, 99, 107, 97, 103, 101, 45, 100, 111, 99, 115, 0, 123, 125, 0, 70, 9, 112, 114, 111, 100, 117, 99, 101, 114, 115, 1, 12, 112, 114, 111, 99, 101, 115, 115, 101, 100, 45, 98, 121, 2, 13, 119, 105, 116, 45, 99, 111, 109, 112, 111, 110, 101, 110, 116, 6, 48, 46, 49, 56, 46, 50, 16, 119, 105, 116, 45, 98, 105, 110, 100, 103, 101, 110, 45, 114, 117, 115, 116, 6, 48, 46, 49, 54, 46, 48];
